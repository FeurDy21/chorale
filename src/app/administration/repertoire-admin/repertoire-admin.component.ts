...
import { Repertoire } from 'src/app/Models/repertoire.Model';
import { RepertroireServiceService } from 'src/app/Services/repertroire-service.service';
import { RepertoireComponentComponent } from 'src/app/repertoire-component/repertoire-component.component';
...
@Component({
  selector: 'app-repertoire-admin',
  templateUrl: './repertoire-admin.component.html',
  styleUrls: ['./repertoire-admin.component.css']
})
export class RepertoireAdminComponent implements OnInit  {
...
constructor(private repertoire_service:RepertroireServiceService) { }
 ...
 //Recherche rapide via des mots clés
  ...
  public onSubmit(repertoire:Repertoire):void{
   ...
   //alert(JSON.stringify(repertoire));
